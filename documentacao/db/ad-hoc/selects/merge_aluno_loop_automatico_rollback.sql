...
BEGIN
    RAISE NOTICE 'INICIANDO SIMULAÇÃO DE MERGE (ROLLBACK GARANTIDO) ...';
    ...
    -- FORÇA O ERROR PARA FAZER ROLLBACK
    RAISE EXCEPTION 'FIM DA SIMULAÇÃO: ROLLBACK EXECUTADO COM SUCESSO. NENHUM DADO FOI ALTERADO.';
