CREATE OR REPLACE FUNCTION public.listar_turmas_disponiveis_docente(
...
select
  ...
  to_char(t.dt_ini_inscri_docente at time zone 'America/Sao_Paulo', 'YYYY-MM-DD') as dt_ini_inscri_docente,
  to_char(t.dt_fim_inscri_docente at time zone 'America/Sao_Paulo', 'YYYY-MM-DD') as dt_fim_inscri_docente,
...
where
  ...
  and (
    ...
    or (
      ...
      (t.dt_ini_inscri_docente at time zone 'America/Sao_Paulo')::date <= (p.d at time zone 'America/Sao_Paulo')::date
      and (t.dt_fim_inscri_docente at time zone 'America/Sao_Paulo')::date >= (p.d at time zone 'America/Sao_Paulo')::date
    )
  )
group by
  ...
  t.dt_ini_inscri_docente, t.dt_fim_inscri_docente, t.dt_ini_curso, t.dt_fim_curso,
  t.link_video
order by
