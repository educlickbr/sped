DROP function public.nxt_get_respostas_usuario_turma;
...
BEGIN
    ...
    fake AS (
        SELECT * FROM (
            VALUES
                (gen_random_uuid(), 'nome', 'Nome', 'texto', 'dados_pessoais'::bloco_pergunta, 1, 1, false, 1, 36, false, NULL::uuid, v_user_nome, true),
                (gen_random_uuid(), 'sobrenome', 'Sobrenome', 'texto', 'dados_pessoais'::bloco_pergunta, 2, 1, false, 1, 36, false, NULL::uuid, v_user_sobrenome, true),
                (gen_random_uuid(), 'email', 'E-mail', 'texto', 'dados_pessoais'::bloco_pergunta, 3, 1, false, 2, 36, false, NULL::uuid, v_user_email, true)
